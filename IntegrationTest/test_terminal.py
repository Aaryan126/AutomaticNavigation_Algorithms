...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Set up QTextEdit widget for displaying output
        ...
        #Terminal Window
        # self.terminal_window = QWidget(self)
        # self.terminal_window.setStyleSheet("background-color: white; border: 1px solid black;")
        # self.terminal_window.setGeometry(700, 200, 100, 100)
        # self.terminal_label = QLabel("Sensor Data")
        # self.terminal_label.setGeometry(700, 430, 450, 220)
        # self.terminal_window.show()

        # Create QTextEdit widget for displaying terminal output
        self.output_text = QTextEdit(self)
        self.output_text.setReadOnly(True)  # Make it read-only
        self.output_text.setGeometry(700, 200, 300, 200)  # Manually set position and size
        self.output_text.setStyleSheet("background-color: white; border: 1px solid black;")

        # Redirect sys.stdout to the QTextEdit widget
        sys.stdout = RedirectedOutput(self.output_text)
    ...
    def closeEvent(self, event):
        # Reset sys.stdout when closing the window
