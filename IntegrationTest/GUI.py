...
class Map(QWidget):
    ...
    def paintEvent(self, event):
        ...
        painter.setBrush(QBrush(QColor(0, 0, 0)))  # Black color for the filled circle
...
class MainWindow(QMainWindow):
    ...
    def resizeEvent(self, event):
        ...
        self.label_radius.setGeometry(int(980 * scale_x), int(195 * scale_y), int(110 * scale_x), int(25 * scale_y))
        ...
        self.radius_input.setGeometry(int(1040 * scale_x), int(195 * scale_y), int(110 * scale_x), int(25 * scale_y))
