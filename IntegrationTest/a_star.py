...
def main():
    ...
    ### Added by Aaryan
    if len(sys.argv) != 5:
        print("Usage: python robot_controller.py start_x start_y end_x end_y")
        sys.exit(1)
    ...
    # sx = 10.0  # [m] # Aaryan commented out
    # sy = 10.0  # [m] # Aaryan commented out
    # gx = 50.0  # [m] # Aaryan commented out
    # gy = 50.0  # [m] # Aaryan commented out
    grid_size = 2.0  # [m]
    robot_radius = 1.0  # [m]
